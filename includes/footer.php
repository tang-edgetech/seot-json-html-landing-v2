            ...
            <footer class="footer w-100 fixed-bottom" id="mastfoot">
                <div class="row px-3 px-md-4 py-2 m-auto w-100">
                    ...
                    <a href="https://win111.one/register/?affiliateCode=win111v1seo5" rel="nofollow noreferrer noopener" class="d-flex flex-column col align-items-center justify-content-center h-100 p-0">
