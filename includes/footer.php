            ...
            <footer class="footer w-100 fixed-bottom" id="mastfoot">
                <div class="row px-3 px-md-4 py-2 m-auto w-100">
                    ...
                    <a href="<?php echo home_url();?>/bonus-dan-promosi/" class="d-flex flex-column col align-items-center justify-content-center h-100 p-0">
                    ...
                    <a href="https://www.win111.asia/register/?affiliateCode=win111v1seo5" rel="nofollow noreferrer noopener" class="d-flex flex-column col align-items-center justify-content-center h-100 p-0">
