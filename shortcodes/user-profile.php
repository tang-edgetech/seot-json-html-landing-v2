            ...
            <div class="col-12 px-4">
                <div class="d-flex flex-wrap p-3 userprofile-container w-100 mt-3" id="userProfileModule">
                    <div class="d-flex flex-wrap p-0 m-0 w-100 justify-content-between mb-3">
                        <a href="<?php echo $user_profile['register'];?>" target="_blank" rel="nofollow noreferrer noopener" class="btn-style text-uppercase btn-section-bg col-6 text-center" style="max-width: 48.5%;" type="button" alt="Register Button" href="#">Daftar</a>
                        <a href="<?php echo $user_profile['login'];?>" target="_blank" rel="nofollow noreferrer noopener" class="btn-style text-uppercase btn-primary col-6 text-center" style="max-width: 48.5%;" type="button" alt="Login Button" href="#">Log Masuk</a>
                    </div>
                    <div class="d-flex m-0 p-0 w-100">
                        ...
                        <div class="col-5 px-0 ">
                            <div class="row m-0 p-0 w-100">
                                <a href="<?php echo $user_profile['deposit'];?>" target="_blank" rel="nofollow noreferrer noopener" class="btn-style btn-primary w-100" type="button" alt="Deposit Button" href="https://kayabet888.com/my-wallet?tab=deposit">
                                ...
                                <a href="<?php echo $user_profile['withdraw'];?>" target="_blank" rel="nofollow noreferrer noopener" class="btn-style btn-section-bg w-100 mt-2 " type="button" alt="withdraw Button" href="https://kayabet888.com/my-wallet?tab=withdraw">
                                    <div class="d-flex align-items-center">
                                ...
                                <a href="<?php echo $user_profile['refresh'];?>" target="_blank" rel="nofollow noreferrer noopener" class="btn-style btn-section-bg w-100 mt-2" type="button" alt="refresh Button" href="https://kayabet888.com/login">
                                    <div class="d-flex align-items-center">
